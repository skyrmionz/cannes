...
export function QuestionScreen({
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center px-4">
      <motion.h2
        className="mb-10 text-center text-2xl font-semibold uppercase tracking-[0.2em] text-white md:text-3xl"
      ...
      <motion.button
        onClick={onBack}
        className="mt-10 rounded-sm border border-neutral-700 px-6 py-3 text-sm font-semibold uppercase tracking-[0.2em] text-neutral-300 transition-colors hover:border-[#E10600] hover:text-white"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
