...
// All 11 teams — each carries a melodyGroup that maps to one of 5 audio stems (S1–S5).
// Modulo pattern: teams 1,6 → red-bull, 2,7 → ferrari, 3,8 → mclaren,
// 4,9 → mercedes, 5,10,11 → haas.
